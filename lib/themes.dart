...
class XpeedWalletTheme extends BaseTheme {
  ...
  OverlayTheme qrScanTheme = OverlayTheme.XPEEDTHEME;
  FPDialogTheme fpTheme = FPDialogTheme.XPEEDTHEME;
  AppIconEnum appIcon = AppIconEnum.XPEEDTHEME;
}
...
class XpeedTheme extends BaseTheme {
  static const teal = Color(0xFF5696E9);

  static const orange = Color(0xFFC27BFF);

  static const orangeDark = Color(0xFF9A4ADF);
...
enum AppIconEnum { XPEEDTHEME, TITANIUM, INDIUM, NEPTUNIUM, XPEED }
class AppIcon {
  ...
  static Future<void> setAppIcon(AppIconEnum iconToChange) async {
    ...
    String iconStr = "xpeed";
    switch (iconToChange) {
      case AppIconEnum.XPEED:
        iconStr = "xpeed";
        break;
