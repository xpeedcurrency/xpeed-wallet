...
import 'package:xpeed_wallet_flutter/ui/home_page.dart';
import 'package:xpeed_wallet_flutter/ui/lock_screen.dart';
import 'package:xpeed_wallet_flutter/ui/intro/intro_welcome.dart';
import 'package:xpeed_wallet_flutter/ui/intro/intro_backup_seed.dart';
import 'package:xpeed_wallet_flutter/ui/intro/intro_backup_confirm.dart';
import 'package:xpeed_wallet_flutter/ui/intro/intro_import_seed.dart';
    ...
    try {
      ...
      if (isLoggedIn) {
        if (await sl.get<SharedPrefsUtil>().getLock() || await sl.get<SharedPrefsUtil>().shouldLock()) {
          ...
          await XpeedUtil().loginAccount(context);
