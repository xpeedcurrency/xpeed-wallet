...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Xpeed Wallet. Μόλις λάβετε XPEED, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("Η αποσύνδεση θα διαγράψει το seed σας και όλα τα δεδομένα σχετικά με το Xpeed Wallet από αυτή τη συσκευή. Εάν δεν έχετε δημιουργήσει αντίγραφο ασφαλείας του seed σας, δεν θα έχετε ποτέ ξανά πρόσβαση στα χρήματά σας."),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Ανοίξτε το Xpeed Wallet για να δείτε αυτή τη συναλλαγή."),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("Πατήστε για να ανοίξετε"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 XPEED"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Να σταλθούν %1 Xpeed?"),
    ...
    "shareXpeedWallet" : MessageLookupByLibrary.simpleMessage("Κοινοποιήστε το Xpeed Wallet"),
    "shareXpeedWalletText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Xpeed Wallet! Το καλύτερο πορτοφόλι για XPEED σε κινητά τηλέφωνα!"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Xpeed Wallet. Για να συνεχίσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον."),
