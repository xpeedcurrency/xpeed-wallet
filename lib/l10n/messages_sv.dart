...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Välkommen till Xpeed Wallet. Så snart du tar emot XPEED, visas transaktionerna på detta vis"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("Vid utloggning raderas din seed och all Xpeed Wallet relaterad data från denna enhet. Om du inte har säkerhetskopierat din seed, kommer du aldrig att kunna komma åt dina resurser igen."),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("Det här är ditt nya konto. Så snart du tar emot XPEED, kommer transaktioner att se ut så här:"),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Öppna Xpeed Wallet för att visa transaktion."),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("Tryck för att öppna"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Mottog %1 XPEED"),
    ...
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("Skanna en Xpeed\nadress QR-kod"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Skicka %1 Xpeed?"),
    ...
    "shareXpeedWallet" : MessageLookupByLibrary.simpleMessage("Dela Xpeed Wallet"),
    "shareXpeedWalletText" : MessageLookupByLibrary.simpleMessage("Kolla in Xpeed Wallet! Xpeeds officiella Androidplånbok!"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 XPEED har överförts till din Xpeed Wallet-plånbok."),
    "transferConfirmInfo" : MessageLookupByLibrary.simpleMessage("En plånbok med ett saldo om %1 XPEED har upptäckts.\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("Den här processen kommer att överföra medel från en pappersplånbok till din Xpeed Wallet-plånbok.\n\nTryck på \"%1\" knappen för att starta."),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("Denna seed innehåller inga XPEED."),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("Denna QR-kod innehåller ingen giltig seed."),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Skanna en Xpeed \nseed eller en privat nyckel"),
    "unlock" : MessageLookupByLibrary.simpleMessage("Olåst"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("Verifiera för att låsa upp Xpeed Wallet"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("Ange PIN för att låsa upp Xpeed Wallet"),
    "viewDetails" : MessageLookupByLibrary.simpleMessage("Visa detaljer"),
    "warning" : MessageLookupByLibrary.simpleMessage("Varning"),
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Välkommen till Xpeed Wallet. För att fortsätta, behöver du skapa en ny plånbok eller importera en befintlig."),
    "xMinute" : MessageLookupByLibrary.simpleMessage("Efter %1 minute"),
    "xMinutes" : MessageLookupByLibrary.simpleMessage("Efter %1 minutes"),
    "xpeedWallet" : MessageLookupByLibrary.simpleMessage("Xpeed Wallet-plånbok"),
