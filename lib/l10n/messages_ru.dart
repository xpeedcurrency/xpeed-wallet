...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Добро пожаловать в Xpeed Wallet.Когда вы получите или отправите XPEED,это будет отображено ниже."),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("Выход из системы приведёт к удалению Seed и всех связанных с Xpeed Wallet данных с этого устройства.Если ваш Seed не будет скопирован,вы больше никогда не сможете получить доступ к своим средствам."),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("Это ваш новый аккаунт. Как только вы получите XPEED, транзакции будут выглядеть так:"),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Откройте Xpeed Wallet для просмотра."),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("Нажмите чтобы открыть"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Получено %1 XPEED"),
    ...
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("Сканировать  QR-код Xpeed/адрес."),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Отправить %1 Xpeed"),
    ...
    "shareXpeedWallet" : MessageLookupByLibrary.simpleMessage("Поделиться Xpeed Wallet"),
    "shareXpeedWalletText" : MessageLookupByLibrary.simpleMessage("Оцените Xpeed Wallet! Официальный Android кошелёк Xpeed!"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 XPEED успешно переведены в Xpeed Wallet кошелёк."),
    "transferConfirmInfo" : MessageLookupByLibrary.simpleMessage("Обнаружен кошелёк с балансом %1 XPEED.\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("Этот процесс переведёт средства с бумажного кошелька на ваш Xpeed Wallet кошелёк.\n\nНажмите кнопку \"%1\" чтобы начать."),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("На этом seed нет XPEED."),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("Этот QR не содержит действительного seed"),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Сканировать Xpeed \nseed или закрытый ключ"),
    "unlock" : MessageLookupByLibrary.simpleMessage("Открыть"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("Аутентификация для разблокировки Xpeed Wallet"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("Введите PIN-код, чтобы разблокировать Xpeed Wallet"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Добро пожаловать в Xpeed Wallet. Чтобы продолжить, можно создать новый кошелек или импортировать уже существующий."),
    "xMinute" : MessageLookupByLibrary.simpleMessage("Через %1 мин."),
    "xMinutes" : MessageLookupByLibrary.simpleMessage("Через %1 мин."),
    "xpeedWallet" : MessageLookupByLibrary.simpleMessage("Xpeed Wallet кошелёк"),
