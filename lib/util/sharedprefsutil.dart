...
import 'package:xpeed_wallet_flutter/util/encrypt.dart';
...
class SharedPrefsUtil {
  // Keys
  static const String first_launch_key = 'fxwallet_first_launch';
  static const String seed_backed_up_key = 'fxwallet_seed_backup';
  static const String app_uuid_key = 'fxwallet_app_uuid';
  static const String price_conversion = 'fxwallet_price_conversion_pref';
  static const String auth_method = 'fxwallet_auth_method';
  static const String cur_currency = 'fxwallet_currency_pref';
  static const String cur_language = 'fxwallet_language_pref';
  static const String cur_theme = 'fxwallet_theme_pref';
  static const String user_representative = 'fxwallet_user_rep'; // For when non-opened accounts have set a representative
  static const String firstcontact_added = 'fxwallet_first_c_added';
  static const String notification_enabled = 'fxwallet_notification_on';
  static const String lock_kalium = 'fxwallet_lock_dev';
  static const String kalium_lock_timeout = 'fxwallet_lock_timeout';
  // For maximum pin attempts
  static const String pin_attempts = 'fxwallet_pin_attempts';
  static const String pin_lock_until = 'fxwallet_lock_duraton';
  // For certain keystore incompatible androids
  static const String use_legacy_storage = 'fxwallet_legacy_storage';
  ...
  Future<ThemeSetting> getTheme() async {
    return ThemeSetting(ThemeOptions.values[await get(cur_theme, defaultValue: ThemeOptions.XPEEDTHEME.index)]);
  }
