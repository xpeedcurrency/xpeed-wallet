...
import 'package:xpeed_wallet_flutter/model/wallet.dart';
...
import 'package:xpeed_wallet_flutter/network/model/block_types.dart';
import 'package:xpeed_wallet_flutter/util/ninja/ninja_node.dart';
import 'package:xpeed_wallet_flutter/network/model/request_item.dart';
import 'package:xpeed_wallet_flutter/network/model/request/accounts_balances_request.dart';
import 'package:xpeed_wallet_flutter/network/model/request/account_history_request.dart';
import 'package:xpeed_wallet_flutter/network/model/request/fcm_update_request.dart';
import 'package:xpeed_wallet_flutter/network/model/request/subscribe_request.dart';
import 'package:xpeed_wallet_flutter/network/model/request/block_info_request.dart';
import 'package:xpeed_wallet_flutter/network/model/request/pending_request.dart';
import 'package:xpeed_wallet_flutter/network/model/request/process_request.dart';
import 'package:xpeed_wallet_flutter/network/model/response/account_history_response.dart';
import 'package:xpeed_wallet_flutter/network/model/response/account_history_response_item.dart';
import 'package:xpeed_wallet_flutter/network/model/response/callback_response.dart';
...
import 'package:xpeed_wallet_flutter/network/model/response/subscribe_response.dart';
import 'package:xpeed_wallet_flutter/network/model/response/process_response.dart';
import 'package:xpeed_wallet_flutter/network/model/response/pending_response.dart';
import 'package:xpeed_wallet_flutter/network/model/response/pending_response_item.dart';
import 'package:xpeed_wallet_flutter/util/sharedprefsutil.dart';
import 'package:xpeed_wallet_flutter/util/xpeedutil.dart';
...
class StateContainerState extends State<StateContainer> {
  ...
  BaseTheme curTheme = XpeedWalletTheme();
  ...
  Future<void> updateWallet({Account account}) async {
    String address = await XpeedUtil().seedToAddressInIsolate(await sl.get<Vault>().getSeed(), account.index);
  ...
  Future<String> _getPrivKey() async {
   return await XpeedUtil().seedToPrivateInIsolate(await sl.get<Vault>().getSeed(), selectedAccount.index);
  }
