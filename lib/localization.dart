...
import 'package:xpeed_wallet_flutter/model/available_language.dart';
...
class AppLocalization {
  ...
  String get welcomeText {
    return Intl.message("Welcome to Xpeed Wallet. To begin you may create a new wallet or import an existing one.",
  ...
  String get sendAmountConfirm {
    return Intl.message("Send %1 XPD",
  ...
  String get shareXpeedWallet {
    return Intl.message("Share Xpeed Wallet",
      desc: 'settings_share', name: 'shareXpeedWallet');
  }

  String get shareXpeedWalletText {
    return Intl.message("Check out XPEED! A official XPD mobile wallet!",
      desc: 'share_extra', name: 'shareXpeedWalletText');
  }
  ...
  String get logoutDetail {
    return Intl.message("Logging out will remove your seed and all Xpeed Wallet-related data from this device. If your seed is not backed up, you will never be able to access your funds again",
  ...
  String get notificationTitle {
    return Intl.message("Received %1 XPD",
      desc: 'notification_title', name: 'notificationTitle');
  }

  String get notificationBody {
    return Intl.message("Open Xpeed Wallet to view this transaction",
  ...
  String get xpeedWallet {
    return Intl.message("Xpeed Wallet",
      desc: 'xpeed_wallet', name: 'xpeedWallet');
  }
  ...
  String get transferIntro {
    return Intl.message("This process will transfer the funds from a paper wallet to your Xpeed wallet.\n\nTap the \"%1\" button to start.",
      desc: 'transfer_intro', name: 'transferIntro');
  }

  String get transferQrScanHint {
    return Intl.message("Scan a Xpeed \nseed or private key",
  ...
  String get transferNoFunds {
    return Intl.message("This seed does not have any XPD on it",
  ...
  String get transferConfirmInfo {
    return Intl.message("A wallet with a balance of %1 XPD has been detected.\n",
  ...
  String get transferComplete {
    return Intl.message("%1 XPD successfully transferred to your Xpeed Wallet.\n",
  ...
  String get unlockPin {
    return Intl.message("Enter PIN to Unlock Xpeed Wallet",
      desc: 'unlock_xpeed_pin', name: 'unlockPin');
  }

  String get unlockBiometrics {
    return Intl.message("Authenticate to Unlock Xpeed Wallet",
      desc: 'unlock_xpeed_bio', name: 'unlockBiometrics');
  }
  ...
  String get exampleCardIntro {
    return Intl.message("Welcome to XPEED WALLET. Once you receive XPD, transactions will show up like this:",
  ...
  String get newAccountIntro {
    return Intl.message("This is your new account. Once you receive XPD, transactions will show up like this:",
  ...
  String getBlockExplorerUrl(String hash) {
    return 'https://xpdnode.com/explorer/block/$hash';
  }

  String getAccountExplorerUrl(String account) {
    return 'https://xpdnode.com/explorer/account/$account';
  }

  String get eulaUrl {
    return 'https://xpeedcoin.com/wallet/eula';
  }

  String get privacyUrl {
    return 'https://xpeedcoin.com/wallet/privacy';
  }
  ...
  String get touchhint {
    return Intl.message("Touch sensor",
      desc: "Touch sensor", name: 'touchhint');
  }

  
  String get fingerprintNotRecognized {
    return Intl.message("Try again",
      desc: "fingerprintNotRecognized", name: 'fingerprintNotRecognized');
  }
  
  String get fingerprintSuccess {
    return Intl.message("Fingerprint recognized",
      desc: "fingerprintSuccess", name: 'fingerprintSuccess');
  }
