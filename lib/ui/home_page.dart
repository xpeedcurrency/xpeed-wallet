...
import 'package:xpeed_wallet_flutter/ui/widgets/auto_resize_text.dart';
...
import 'package:xpeed_wallet_flutter/model/list_model.dart';
...
import 'package:xpeed_wallet_flutter/ui/send/send_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/send/send_confirm_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/send/send_complete_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/receive/receive_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/settings/settings_drawer.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/buttons.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/app_drawer.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/app_scaffold.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/sheets.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/list_slidable.dart';
import 'package:xpeed_wallet_flutter/ui/util/routes.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/reactive_refresh.dart';
...
class _AppHomePageState extends State<AppHomePage>
  ...
  // Price conversion state (BTC, XPD, NONE)
  PriceConversion _priceConversion;
  bool _pricesHidden = true;
  ...
  Future<void> _addSampleContact() async {
    ...
    if (!contactAdded) {
      bool addressExists = await sl.get<DBHelper>().contactExistsWithAddress(
          "xpd_33wyhk33mfx1xnbdsoz4ju8f8csn4uuw54zq8oap8b6a8o3n1ha7w187wgt5");
      if (addressExists) {
        return;
      }
      bool nameExists = await sl.get<DBHelper>().contactExistsWithName("@XpdDonations");
      if (nameExists) {
        return;
      }
  ...
  TextSpan _getExampleHeaderSpan(BuildContext context) {
    ...
    // Colorize XPD
    List<String> splitStr = workingStr.split("XPD");
                      ...
                      TextSpan(
                        children: [
                          ...
                          TextSpan(
                            ...
                            style: AppStyles.textStyleCurrencyWhite(context),
                          ),
                        ],
                      ),
                      maxLines: 1,
