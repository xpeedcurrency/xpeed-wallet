...
import 'package:xpeed_wallet_flutter/ui/accounts/accountdetails_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/accounts/accounts_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/app_simpledialog.dart';
...
import 'package:xpeed_wallet_flutter/bus/events.dart';
import 'package:xpeed_wallet_flutter/model/address.dart';
import 'package:xpeed_wallet_flutter/model/authentication_method.dart';
import 'package:xpeed_wallet_flutter/model/available_currency.dart';
import 'package:xpeed_wallet_flutter/model/device_unlock_option.dart';
import 'package:xpeed_wallet_flutter/model/device_lock_timeout.dart';
import 'package:xpeed_wallet_flutter/model/notification_settings.dart';
import 'package:xpeed_wallet_flutter/model/available_language.dart';
import 'package:xpeed_wallet_flutter/model/available_themes.dart';
...
import 'package:xpeed_wallet_flutter/ui/settings/backupseed_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/contacts/add_contact.dart';
import 'package:xpeed_wallet_flutter/ui/contacts/contact_details.dart';
import 'package:xpeed_wallet_flutter/ui/settings/changerepresentative_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/settings/settings_list_item.dart';
import 'package:xpeed_wallet_flutter/ui/transfer/transfer_overview_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/transfer/transfer_confirm_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/transfer/transfer_complete_sheet.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/buttons.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/dialog.dart';
import 'package:xpeed_wallet_flutter/ui/widgets/security.dart';
import 'package:xpeed_wallet_flutter/ui/util/ui_util.dart';
...
import 'package:xpeed_wallet_flutter/util/numberutil.dart';
import 'package:xpeed_wallet_flutter/util/caseconverter.dart';
...
class _SettingsSheetState extends State<SettingsSheet>
  ...
  ThemeSetting _curThemeSetting = ThemeSetting(ThemeOptions.XPEEDTHEME);
  ...
  Future<void> _exportContacts() async {
    ...
    String filename =
        "xpeedwalletcontacts_${exportTime.year}${exportTime.month}${exportTime.day}${exportTime.hour}${exportTime.minute}${exportTime.second}.txt";
              ...
              children: <Widget>[
                ListView(
                  ...
                  children: <Widget>[
                    ...
                    AppSettings.buildSettingsListItemSingleLine(
                        context,
                        AppLocalization.of(context).shareXpeedWallet,
                        AppIcons.share, onPressed: () {
                      Share.share(
                          // "Check out Xpeed Wallet" +
                          //     " https://xpeedcoin.com");
                          AppLocalization.of(context).shareXpeedWalletText);
                    }),
                    Divider(
                      height: 2,
                      color: StateContainer.of(context).curTheme.text15,
