...
import 'package:xpeed_wallet_flutter/ui/util/formatters.dart';
...
class AppSendSheet {
  ...
  void toggleLocalCurrency(BuildContext context, StateSetter setState) {
    // Keep a cache of previous amounts because, it's kinda nice to see approx what xpeed is worth
    // this way you can tap button and tap back and not end up with X.9993451 XPD
    if (_localCurrencyMode) {
