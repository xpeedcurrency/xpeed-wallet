...
public class Vault {
    ...
    private static final String AUTOMATICALLY_KEYED_PREF_FILE_NAME = "co.xpeed.xpeedfwallet.automaticallyKeyedPref";
    private static final String AUTOMATICALLY_KEYED_KEY_FILE_NAME = "co.xpeed.xpeedfwallet.automaticallyKeyedKey";
    private static final String AUTOMATICALLY_KEYED_KEY_ALIAS = "co.xpeed.xpeedfwallet.automaticallyKeyed";
